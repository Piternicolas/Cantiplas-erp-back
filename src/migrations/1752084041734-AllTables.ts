...
export class AllTables1752084041734 implements MigrationInterface {
    name = 'AllTables1752084041734'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."tb_extrusao_maquina_ext_enum" AS ENUM('carnevalli', 'ciola', 'rulli', 'outra')`);
        await queryRunner.query(`CREATE TYPE "public"."tb_extrusao_tratamento_enum" AS ENUM('sim', 'simples', 'duplo')`);
        await queryRunner.query(`CREATE TABLE "tb_extrusao" ("extrusao_id" SERIAL NOT NULL, "descricao_ext" character varying(255), "maquina_ext" "public"."tb_extrusao_maquina_ext_enum" NOT NULL, "kg_extrusado" numeric(5,1) NOT NULL DEFAULT '0', "apara_ext" numeric(5,1) DEFAULT '0', "calibrador" numeric(2) NOT NULL DEFAULT '0', "pigmento" character varying(50) DEFAULT 'nao', "metragem" numeric(10,2) NOT NULL DEFAULT '0', "tratamento" "public"."tb_extrusao_tratamento_enum" NOT NULL, "aba" numeric(4,2) NOT NULL DEFAULT '0', "data_fim_ext" TIMESTAMP, "pedido_id" integer, CONSTRAINT "REL_efc63cc6f9d42ea64677299306" UNIQUE ("pedido_id"), CONSTRAINT "PK_495452c1bc50e1c62bb35b78598" PRIMARY KEY ("extrusao_id"))`);
        await queryRunner.query(`CREATE TYPE "public"."tb_impressao_maquina_imp_enum" AS ENUM('quatro_cores', 'seis_cores')`);
        await queryRunner.query(`CREATE TYPE "public"."tb_impressao_cyrel_enum" AS ENUM('novo', 'velho')`);
        await queryRunner.query(`CREATE TABLE "tb_impressao" ("impressao_id" SERIAL NOT NULL, "descricao_imp" character varying(255), "maquina_imp" "public"."tb_impressao_maquina_imp_enum" NOT NULL, "kg_impresso" numeric(5,1) NOT NULL DEFAULT '0', "apara_imp" numeric(5,1) NOT NULL DEFAULT '0', "metragem" numeric(10,2) NOT NULL DEFAULT '0', "cilindro" numeric(2) NOT NULL DEFAULT '0', "pasta_cliche" numeric(4) NOT NULL DEFAULT '0', "cyrel" "public"."tb_impressao_cyrel_enum" NOT NULL, "data_fim_imp" TIMESTAMP, "pedido_id" integer, CONSTRAINT "REL_6657396fb7d248bac4a602b14c" UNIQUE ("pedido_id"), CONSTRAINT "PK_8532c4a957b357fbdc8168f11c9" PRIMARY KEY ("impressao_id"))`);
        await queryRunner.query(`CREATE TYPE "public"."tb_corte_maquina_corte_enum" AS ENUM('sacolheira', 'maquina_1', 'maquina_2', 'maquina_3', 'maquina_4')`);
        await queryRunner.query(`CREATE TABLE "tb_corte" ("corte_id" SERIAL NOT NULL, "descricao_corte" character varying(255), "maquina_corte" "public"."tb_corte_maquina_corte_enum" NOT NULL, "kg_cortado" numeric(5,1) NOT NULL DEFAULT '0', "apara_corte" numeric(5,1) NOT NULL DEFAULT '0', "milheiro_final" numeric(6,2) NOT NULL DEFAULT '0', "volumes" numeric(3) NOT NULL DEFAULT '0', "pedido_id" integer, CONSTRAINT "REL_59922a1b53bbef5f9288ac0b45" UNIQUE ("pedido_id"), CONSTRAINT "PK_c87ed0a9f18b705c5f6d8e80e55" PRIMARY KEY ("corte_id"))`);
